// Modbus
export const FUNCTION = { READ: 0x03, WRITE: 0x10 }

// modbus format sizes
export const CRC_BYTE_SIZE = 2
...
export const WRITE_RESPONSE_RAW_BYTE_SIZE = WRITE_RESPONSE_HEADER_BYTE_SIZE
export const WRITE_RESPONSE_BYTE_SIZE = WRITE_RESPONSE_RAW_BYTE_SIZE + CRC_BYTE_SIZE
...
export const READ_RESPONSE_RAW_BYTE_SIZE_BASE = READ_RESPONSE_HEADER_BYTE_SIZE
export const READ_RESPONSE_BYTE_SIZE_BASE = READ_RESPONSE_RAW_BYTE_SIZE_BASE + CRC_BYTE_SIZE
...
export const ERROR_RESPONSE_RAW_BYTE_SIZE = ERROR_RESPONSE_HEADER_BYTE_SIZE
export const ERROR_RESPONSE_BYTE_SIZE = ERROR_RESPONSE_RAW_BYTE_SIZE + CRC_BYTE_SIZE

// error base and value map
const ERROR_BASE = 0x80
export const ERROR_MASK = 0x80
